...
var A = (n, o, e) => o in n ? S(n, o, { enumerable: true, configurable: true, writable: true, value: e }) : n[o] = e;
var w = (n, o, e) => (A(n, typeof o != "symbol" ? o + "" : o, e), e);
var k = ".wrapper{--color-button-bg: hsl(242deg 9.58% 98%);--color-button-text: hsl(242deg 55.5% 2.74%);--color-copy-success: hsl(120deg 99% 43%);--color-popover-bg: hsl(242deg 55.5% 2.74%);--color-popover-text: hsl(242deg 9.58% 98%)}";
function V(n) {
...
var y = '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M6 4v4h12V4h2.007c.548 0 .993.445.993.993v16.014a.994.994 0 0 1-.993.993H3.993A.993.993 0 0 1 3 21.007V4.993C3 4.445 3.445 4 3.993 4zm2-2h8v4H8z"/></svg>';
...
function z({
      ...
      return i.innerHTML = t ? v : s, i.addEventListener("click", async (p) => {
        ...
        try {
          await navigator.clipboard.writeText(window.location.href), i.disabled = true, t ? (console.log(f), i.innerHTML = f) : i.innerHTML = `${f} <span>Copied!</span>`, setTimeout(() => {
            i.disabled = false, i.innerHTML = t ? v : s;
          }, 5e3);
        } catch {
  ...
  C.classList.add("triangle-up"), r.prepend(C);
  const g = document.createElement("div");
  return g.classList.add("triangle-down"), r.append(g), t ? h : r;
}
...
var H = class extends HTMLElement {
  constructor() {
    super(...arguments);
    w(this, "isPopoverSupport", Object.prototype.hasOwnProperty.call(
      HTMLElement.prototype,
      "popover"
    ));
    w(this, "isMobile", (/android/i.test(navigator.userAgent) || /iPhone|iPad|iPod/i.test(navigator.userAgent)) && navigator.share);
    w(this, "shadow", this.attachShadow({ mode: "open" }));
    w(this, "state", false);
  }
  connectedCallback() {
    this.render();
  ...
  render() {
    ...
    if (!d && m && m.addEventListener("click", (s) => {
      ...
      addEventListener("resize", s), addEventListener("scroll", s);
    }
  }
  createIcon() {
  ...
  createButton(e) {
    ...
    const a = this.hasAttribute("notext");
    return this.isPopoverSupport && !this.isMobile && t.setAttribute("popovertarget", "share-popover"), this.hasAttribute("circle") || a ? (t.setAttribute("aria-label", "Share"), t.setAttribute(
      "style",
  ...
  createPopover(e, t = false) {
    const a = this.getAttribute("networks") || "x, linkedin, facebook, email, whatsapp, telegram, copy", d = z({
      url: window.location.href,
      title: e,
...
w(H, "observedAttributes", ["dark-mode"]);
