...
var k = ".wrapper{--color-popover-bg: hsl(242deg 55.5% 2.74%);--color-popover-text: hsl(242deg 9.58% 98%);--color-button-bg: hsl(242deg 9.58% 98%);--color-button-text: hsl(242deg 55.5% 2.74%);--color-green: hsl(120deg 99% 43%)}";
function A(n) {
